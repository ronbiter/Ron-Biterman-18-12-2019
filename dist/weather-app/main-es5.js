...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            var WeatherTileComponent = /** @class */ (function () {
                function WeatherTileComponent() {
                }
                WeatherTileComponent.prototype.ngOnInit = function () {
                };
                return WeatherTileComponent;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BACKEND_URL = src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].apiUrl + 'forecast/v1';
            var API_KEY = src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].apiKey;
            var WeatherService = /** @class */ (function () {
                ...
                WeatherService.prototype.toggleMetricUnits = function () {
                    this.isMetric = !this.isMetric;
                };
                WeatherService.prototype.getCurrentWeather = function (key) {
                };
                WeatherService.prototype.getWeatherForCityFiveDays = function (key) {
                    var _this = this;
                    var queryParams = "?apikey=" + API_KEY + "&metric=" + this.isMetric;
                    if (!src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].production) {
                        this.http.get('assets/stubs/forecast/fiveDay').subscribe(function (data) {
                            // this.autocompleteResults = data;
                            _this.fiveDaysForecastUpdate.next(data);
                        });
                    }
                    else {
                ...
                WeatherService.prototype.getFiveDaysForecastUpdateListener = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var src_environments_environment__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/environments/environment */ "./src/environments/environment.ts");
            var BACKEND_URL = src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].apiUrl + 'locations/v1';
            var API_KEY = src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].apiKey;
            var LocationsService = /** @class */ (function () {
                function LocationsService(http, router) {
                    this.http = http;
                    this.router = router;
                ...
                LocationsService.prototype.getCurrentLocationByLatLong = function (lat, long) {
                    var _this = this;
                    var queryParams = "?apikey=" + API_KEY + "&q=" + lat + "," + long + "&toplevel=true";
                    if (!src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].production) {
                        this.http.get('assets/stubs/location/getLocationByLatLong')
                            .subscribe(function (data) {
                            _this.currentPosUpdate.next(data);
                        });
                    }
                    else {
                ...
                LocationsService.prototype.getAutocompleteCitys = function (value) {
                    var _this = this;
                    var queryParams = "?apikey=" + API_KEY + "&q=" + value;
                    if (!src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].production) {
                        this.http.get('assets/stubs/location/autocomplete')
                            .subscribe(function (data) {
                            _this.autocompleteResults = data;
                            _this.autocompleteUpdate.next(__spread(data));
                        });
                    }
                    else {
                ...
                LocationsService.prototype.getAutocompleteUpdateListener = function () {
                    return this.autocompleteUpdate.asObservable();
                };
                LocationsService.prototype.getCurrentLocationUpdateListener = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var WeatherDetailsComponent = /** @class */ (function () {
                function WeatherDetailsComponent(locationService, weatherService) {
                ...
                WeatherDetailsComponent.prototype.ngOnInit = function () {
                    ...
                    if (navigator.geolocation) {
                        var geoSuccess = function (position) {
                            _this.currentLatLong = position;
                            _this.locationService.getCurrentLocationByLatLong(position.coords.latitude, position.coords.longitude);
                            _this.currentPosSub = _this.locationService.getCurrentLocationUpdateListener()
                                .subscribe(function (data) {
                                _this.currentLocation = data;
                                _this.selectedLocation = data;
                                _this.weatherService.getWeatherForCityFiveDays(_this.selectedLocation.Key);
                            });
                        };
                    ...
                    this.weaterForecastSub = this.weatherService.getFiveDaysForecastUpdateListener()
                        .subscribe(function (data) {
                        _this.isLoading = false;
                        _this.selectedLocationWeather = data;
                    });
                };
                WeatherDetailsComponent.prototype.onStartSearch = function () {
                ...
                WeatherDetailsComponent.prototype.onSelectCity = function ($event) {
                    console.log($event);
